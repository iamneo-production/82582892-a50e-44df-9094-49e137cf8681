...
function AddAcademy(props) {
  ...
  let formData = {};
  var errors = ["Please fill all the input fields", "invalid phone number"];

  async function postAddAcademy() {
    try {
      const response = await fetch(
        "https://localhost:44358/admin/addInstitute",
        {
          method: "POST",
  ...
  return (
    <div style={{ backgroundColor: "gray", height: "100vh" }}>
      ...
      >
        <h2 className="Add">Add Academy </h2>
        <div className="row">
          <div className="col">
            <input
              ref={academyName}
